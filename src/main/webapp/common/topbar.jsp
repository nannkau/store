    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar">
            <div class="sidebar-header">
                <a href="#"><img src="<c:url value='/themes/img/message/1.jpg'/>" alt="" />
                </a>
                <h3>Andrar Son</h3>
                <p>Developer</p>
                <strong>AP+</strong>
                                        ...
                                        <div role="menu" class="author-message-top dropdown-menu animated flipInX">
                                            ...
                                            <ul class="message-menu">
                                                <li>
                                                    <a href="#">
                                                        <div class="message-img">
                                                            <img src="<c:url value='/themes/img/message/1.jpg'/>" alt="">
                                                        </div>
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <div class="message-img">
                                                            <img src="<c:url value='/themes/img/message/4.jpg'/>" alt="">
                                                        </div>
                                                        <div class="message-content">
                                                            <span class="message-date">16 Sept</span>
                                                            <h2>Sulaiman din</h2>
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <div class="message-img">
                                                            <img src="<c:url value='/themes/img/message/3.jpg'/>" alt="">
                                                        </div>
                                                        <div class="message-content">
                                                            <span class="message-date">16 Sept</span>
                                                            <h2>Victor Jara</h2>
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <div class="message-img">
                                                            <img src="<c:url value='/themes/img/message/2.jpg'/>" alt="">
                                                        </div>
                                                        <div class="message-content">
                                                            <span class="message-date">16 Sept</span>
                                                            <h2>Victor Jara</h2>
                                                            ...
                                                            <ul class="notes-menu-list">
                                                                <li>
                                                                    <a href="#">
                                                                        <div class="notes-list-flow">
                                                                            <div class="notes-img">
                                                                                <img src="<c:url value='/themes/img/notification/5.jpg'/>" alt="" />
                                                                            </div>
                                                                ...
                                                                <li>
                                                                    <a href="#">
                                                                        <div class="notes-list-flow">
                                                                            <div class="notes-img">
                                                                                <img src="<c:url value='/themes/img/notification/1.jpg'/>" alt="" />
                                                                            </div>
                                                                            <div class="notes-content">
                                                                                <p> The point of using Lorem Ipsum is that it has a more-or-less normal.</p>
                                                                                <span>Yesterday 2:45 pm</span>
                                                                ...
                                                                <li>
                                                                    <a href="#">
                                                                        <div class="notes-list-flow">
                                                                            <div class="notes-img">
                                                                                <img src="<c:url value='/themes/img/notification/2.jpg'/>" alt="" />
                                                                            </div>
                                                                            <div class="notes-content">
                                                                                <p> The point of using Lorem Ipsum is that it has a more-or-less normal.</p>
                                                                                <span>Yesterday 2:45 pm</span>
                                                                ...
                                                                <li>
                                                                    <a href="#">
                                                                        <div class="notes-list-flow">
                                                                            <div class="notes-img">
                                                                                <img src="<c:url value='/themes/img/notification/3.jpg'/>" alt="" />
                                                                            </div>
                                                                            <div class="notes-content">
                                                                                <p> The point of using Lorem Ipsum is that it has a more-or-less normal.</p>
                                                                                <span>Yesterday 2:45 pm</span>
                                                                ...
                                                                <li>
                                                                    <a href="#">
                                                                        <div class="notes-list-flow">
                                                                            <div class="notes-img">
                                                                                <img src="<c:url value='/themes/img/notification/4.jpg'/>" alt="" />
                                                                            </div>
                                                                            <div class="notes-content">
                                                                                <p> The point of using Lorem Ipsum is that it has a more-or-less normal.</p>
                                                                                <span>Yesterday 2:45 pm</span>
                                                                ...
                                                                <li>
                                                                    <a href="#">
                                                                        <div class="notes-list-flow">
                                                                            <div class="notes-img">
                                                                                <img src="<c:url value='/themes/img/notification/6.jpg'/>" alt="" />
                                                                            </div>
                                                                            <div class="notes-content">
                                                                                <p> The point of using Lorem Ipsum is that it has a more-or-less normal.</p>
                                                                                <span>Yesterday 2:45 pm</span>
